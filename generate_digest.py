...
function renderSummary() {
  ...
  document.getElementById("detail-summary").innerHTML =
    ...
    "<br><span style='font-size:11px;color:#888;'>Cash flow is rent from occupied units minus this month's expenses. Expenses flagged \"Annual\" (property tax, insurance, etc.) are divided by 12 and spread evenly across all 12 months rather than counted entirely in the month they were logged. A simple estimate, not a full P&amp;L.</span>";
}
